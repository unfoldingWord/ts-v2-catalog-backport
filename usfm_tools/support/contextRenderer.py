...
class ConTeXtRenderer(AbstractRenderer):
    ...
    def render(self):
        ...
        self.f.write(u"""
            Document rendered on """ + datetime.date.today().strftime("%F") + u"""
            \\par
            \\page[right]
            \\par ~
    ...
    def renderID(self, token):      self.f.write( self.stopNarrower() + u"\\marking[RAChapter]{ } \\marking[RABook]{ } \\marking[RASection]{ }" )
