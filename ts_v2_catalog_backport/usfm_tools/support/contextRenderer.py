...
class ConTeXtRenderer(AbstractRenderer):
    ...
    def render(self):
        ...
        self.f.write("""
            Document rendered on """ + datetime.date.today().strftime("%F") + """
            \\par
            \\page[right]
            \\par ~
    ...
    def renderID(self, token):      self.f.write( self.stopNarrower() + "\\marking[RAChapter]{ } \\marking[RABook]{ } \\marking[RASection]{ }" )
